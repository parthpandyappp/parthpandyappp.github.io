...
export const RESUME_LINK =
  "https://drive.google.com/file/d/1SEkIIgToFyG6oJj7LZuwW3nckOisrOHz/view?usp=sharing";

export const SOCIAL_LINKS = [
  {
    name: "Email",
    icon: "far fa-lg fa-envelope",
    link: "mailto:parthpandyappp@gmail.com",
  },
  {
    name: "Github",
    icon: "fab fa-lg fa-github",
    link: "https://github.com/parthpandyappp",
  },
  {
    name: "Linkedin",
    icon: "fab fa-lg fa-linkedin-in",
    link: "https://www.linkedin.com/in/parth-pandya-4215b0152/",
  },
  {
    name: "Twitter",
    icon: "fab fa-lg fa-twitter",
    link: "https://twitter.com/pandyaparthppp",
  },
  {
    name: "Instagram",
    icon: "fab fa-lg fa-instagram",
    link: "https://www.instagram.com/parthpandyappp/",
  },
];
...
export const ABOUT = [
  ...
  {
    index: "3",
    text: "I love to peek under the hood, tinker with & explore technologies and learn new skills.",
  },
  {
    index: "4",
    text: "I'm an avid reader, fond of singing and generally curious about everything that surrounds me.",
  },
];
...
export const ACH = [
  {
    ...
    extlink:
      "https://drive.google.com/file/d/1JL0o3H11AxsTNVTkzJ_pGeHBXeB_sAwp/view",
  },
  {
    ...
    extlink:
      "https://twitter.com/neogcamp/status/1529841676549820419?s=20&t=P3dnFJlXEaAfTR3Tta2e-A",
  },
];
...
export const EXP = [
  {
    ...
    org: "Wizikey",
    icon: "fas fa-key",
    desc: "In my capacity as an SDE-1 (Web) at Wizikey, I actively contribute to the evolution of our product, ensuring it adheres to industry standards. Engaging in collaborative problem-solving discussions with the team, I bring precision to designs and suggest improvements in the overall development journey. My technical skill spans Storybook, GraphQL, Apollo GraphQL, emotion.sh, D3.js, Next.js, TypeScript, Git, React.js, and JavaScript.",
...
export const WORK = [
  {
    title: "Lattice",
    description:
      "A virtual coordinate space to connect and share with your peers about your classy daily experiences or anything you want to share or ask in the form of micro-blogs. Form your mesh community at Lattice, developed with ReactJS, Mockbee’s Rest API, and Redux.",
  ...
  },
  {
    ...
    description:
      "An AI-powered app built using GPT3 (Generative Pre-trained Transformer 3) is an autoregressive language model that uses deep learning text-DaVinci-002 to produce human-like text powered by ReactJS.",
  ...
  },
  {
    title: "PlunkOrders",
    description:
      "An actual business solution for placing and monitoring daily orders. A one-stop solution to place and review business orders, built upon ReactJs & Firebase.",
  ...
  },
  {
    ...
    ghlink: "https://github.com/parthpandyappp/Tweet-Scraper",
    extlink: "https://tweet-scraper.glitch.me/",
  },
  {
    title: "emojiMania",
    description:
      "A single-page react-js powered website demonstrating the use of { useState } react hook which declares a state variable. onClick event deals with this hook and the magic happens! ",
    ghlink: "https://github.com/parthpandyappp/emojiMania",
    extlink: "https://emojimania.netlify.app/",
  },
  {
    title: "Wordize",
    description:
      "Connected two APIs together! It's so cool to see both APIs interacting with one another.It basically uses two APIs, one fetches a word and another fetches meaning to the same word, written in vanillaJS.",
    ghlink: "https://github.com/parthpandyappp/Wordize",
    extlink: "https://wordize.netlify.app/",
  },
  {
    title: "YouTube-tag-script",
    description:
      "A script which adds comma at the end of every line, especially created for ease in applying YouTube tags from external source.",
    ghlink: "https://github.com/parthpandyappp/yelpcampv9",
    extlink: "https://github.com/parthpandyappp/yelpcampv9",
  },
  {
    title: "Mail-Me",
    description:
      "A simple web-app written in Django which sends me a formatted message to my email after data being submitted at the portal.",
    ghlink: "https://github.com/parthpandyappp/Mail-Me",
    extlink: "https://emailman.herokuapp.com/",
  },
  {
    title: "BananaProcessor",
    description:
      "A web-app which translates English to Minionese, a language which minions use to communicate, written in vanillaJS",
    ghlink: "https://github.com/parthpandyappp/BananaProcessor",
    extlink: "https://bananaprocessor.netlify.app/",
  },
];
